            ...
            <>
              ...
              <Form className="mx-auto gap-4" onSubmit={handleSubmit(handleLocalLogin)}>
                ...
                <Button
                  ...
                  size={breakpoint === 'base' ? 'md' : 'lg'}
                  disabled={isSubmitting}
                  className={`w-full mt-2 bg-blue-400 text-white py-4 md:px-10 rounded-full font-bold border-gray-600
    disabled:opacity-50 disabled:hover:bg-blue-400 disabled:pointer-events-none
    ${isSubmitting ? 'hover:bg-blue-500 hover:text-white hover:border-white' : ''}`}
                >
